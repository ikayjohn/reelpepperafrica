    ...
    <Reveal className="group h-full">
      <article className="flex h-full flex-col rounded-card border border-warm-100 bg-white p-6 transition-all duration-150 hover:-translate-y-1 hover:shadow-card-hover">
        <div className="flex items-start justify-between gap-4">
          {icon ? (
            <div className="flex h-10 w-10 items-center justify-center rounded-card bg-gold-100 text-gold-500">
              {icon}
            </div>
          ) : meta ? (
        ...
        {href && (
          <div className="mt-4 inline-flex items-center gap-1.5 text-sm font-medium text-gold-500 transition-colors group-hover:text-gold-900">
